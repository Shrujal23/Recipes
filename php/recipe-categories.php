...
?>
 ...
 <header class="page-header shadow bg-img bg-overlay container-fluid my-5">
    ...
    <main class="categories container">
        ...
        <!-- Best Recipes start -->
        <section class="category">
            <h2 class="category-title text-center">Best Recipes</h2>

            <div class="row">
                <div class="sub-category p-4 col-12 col-sm-6 col-md-3">
                    <a href="php/pizza.php" class="more-recipes-link">
                        <img src="../images/pizza.jpg" alt="Pizza" class="mx-auto d-block">
                        <h3 class="text-center mt-3">Pizza</h3>
                    </a>
                </div>

                <div class="sub-category p-4 col-12 col-sm-6 col-md-3">
                    <a href="php/mango_smoothie.php" class="more-recipes-link">
                        <img src="../images/mango-smoothie.jpg" alt="Mango Smoothie" class="mx-auto d-block">
                        <h3 class="text-center mt-3">Mango Smoothie</h3>
                    </a>
                </div>

                <div class="sub-category p-4 col-12 col-sm-6 col-md-3">
                    <a href="php/cheese_sandwich.php" class="more-recipes-link">
                        <img src="../images/cheese-sandwich.jpg" alt="Cheese Sandwich" class="mx-auto d-block">
                        <h3 class="text-center mt-3">Cheese Sandwich</h3>
                    </a>
                </div>
            </div>
        </section>
